...
public class DomNewsFragment extends MVPFragment implements NewsContract.INewsView{

    @Bind(R.id.rv_news)
    LoadMoreRecyclerView rvNews;
    @Bind(R.id.material_style_ptr_frame)
    PtrClassicFrameLayout mPtrFrame;
    private String TAG = "DomNewsFragment";
    ...
    public DomNewsFragment() {
        // Required empty public constructor
    }


    // TODO: Rename and change types and number of parameters
    public static DomNewsFragment newInstance(int index) {
        DomNewsFragment fragment = new DomNewsFragment();
